...
# -*- coding: utf-8 -*-
# @File Name: tetris.py
# @Author: Copyright (c) 2016-10-20 01:12:56 Gillett Hernandez
# @Date:   2016-10-20 01:12:56
# @Last Modified by:   Gillett Hernandez
# @Last Modified time: 2016-10-20 01:46:25
...
with open("json/tetris_constants.json", 'r') as fd:
    constants = DotDict(json.load(fd))

with open("json/tetris_keyconfig.json", 'r') as fd:
...
class PlayerEventHandler(EventHandler):
    def __init__(self, obj):
        ...
        def right(**kwargs):
            self.obj.dispatch_event(Event("change_gravity", {}))
        self.add_hold("right", "move", right)
